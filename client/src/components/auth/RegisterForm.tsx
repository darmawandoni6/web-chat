  ...
  return (
    <div className="w-full max-w-md p-8 rounded-2xl border bg-[var(--card)] border-[var(--border)] shadow-2xl space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-[var(--muted-foreground)]">Join WebChat and connect with everyone</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-1">
          <label className="text-xs font-semibold text-[var(--muted-foreground)]">Username</label>
